Spark Apps (Scala)
==================
[![Build Status](https://travis-ci.org/nholuongut/spark-apps.svg?branch=master)](https://travis-ci.org/nholuongut/spark-apps)
...
-->
This is based off my Pig & Hive freebies for indexing structured and unstructured data in Hadoop to Elasticsearch & Solr/SolrCloud, see my adjacent [Toolbox repo](https://github.com/nholuongut/toolbox) for those programs.
...
```
git clone https://github.com/nholuongut/spark-apps
cd spark-apps
make
```
...
```
spark-submit ... --class com.linkedin.nholuongut.spark.TextToElasticsearch \
...
spark-submit --master local[3] \
             --class com.linkedin.nholuongut.spark.KafkaToElasticsearch \
             target/scala-*/spark-apps-assembly-*.jar \
...
```
spark-submit --master local[3] \
             --class com.linkedin.nholuongut.spark.KafkaToTextFiles \
             target/scala-*/spark-apps-assembly-*.jar \
...
```
spark-submit --master local[3] \
             --class com.linkedin.nholuongut.spark.NetworkCounts \
             target/scala-*/spark-apps-assembly-*.jar \
             --host localhost \
             --port 9999 \
             --interval 5
...
* [PyTools](https://github.com/nholuongut/pytools) - programs for Hadoop, Spark, Pig, Elasticsearch, Solr, Linux CLI - contains the original Pig => Elasticsearch / Solr programs this Spark => Elasticsearch application was based off

* [Tools](https://github.com/nholuongut/tools) - dozens of programs for Hadoop, Hive, Solr, Ambari, Web, Linux CLI - contains Hive => Elasticsearch related to this Spark => Elasticsearch program
...
* [My Java utility library](https://github.com/nholuongut/lib-java) - leveraged in this code as a submodule
