...
//
// https://github.com/nholuongut/toolbox
...
object TextToElasticsearch {
  ...
  def main(args: Array[String]) {
    ...
    val parser: String = if (cmd.hasOption("parser")) {
      ...
      "com.linkedin.nholuongut.spark.Parser"
    }
    ...
    */
    ...
    // java.lang.IllegalArgumentException: Class is not registered: com.linkedin.nholuongut.spark.TextToElasticsearch$$anonfun$2
    // Note: To register this class use: kryo.register(com.linkedin.nholuongut.spark.TextToElasticsearch$$anonfun$2.class);
    ...
    val es_map = fileLines.map(l => {
      ...
      //com.linkedin.nholuongut.spark.Parser.parse(l._1.toString(), Long.valueOf(l._2.toString()).longValue(), l._3.toString())
      //parserInstance.parse(_, _, _)
      //parserInstance.parse(l._1.toString(), Long.valueOf(l._2.toString()).longValue(), l._3.toString())
      // this gets rg.elasticsearch.hadoop.serialization.EsHadoopSerializationException: Cannot handle type [class com.linkedin.nholuongut.spark.TextToElasticsearch$$anonfun$2$$anonfun$apply$2], instance [<function3>] using writer [org.elasticsearch.spark.serialization.ScalaValueWriter@xxxxxxxx
      //Parser.parse(_, _, _)
